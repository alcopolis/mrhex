...
function showHelp() {
	...
	$("#inst_main_body").html("<div id = 'instructions_head'>Cara Bermain</div><p>Satukan 3 atau lebih balok-balok sewarna untuk mendapatkan nilai.</p><p>Usahakan agar balok tidak mencapai batas terluar hexagon berwarna abu-abu.</p><p>Gunakan tombol panah kanan atau kiri untuk memutar hexagon.</p> ");
	if (gameState == 1) {
		pause();
	}
